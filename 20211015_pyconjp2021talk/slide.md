...
- さまざま/複数の環境センサーと接続して1つのダッシュボードでモニターできる様にしたい

<!-- _footer: 今は温度湿度気圧センサーのBME280のみに対応してます -->
...
IoTの製品で気温や湿度は見やすくなった。気圧を見られるものがなかった。
...
- センサーノードはラズパイ + センサーを接続したもの
- ダッシュボードはDash + Plotlyを使う
- センサーノードは複数対応
- センサー情報はGoogleスプレッドシートで保存
