...
- 採択結果の前にjpスタッフから依頼を受ける

---

- Slackbotと開発に使うエコシステムな話をしてほしい。エコシステム難しいよ。。。 -> slackbotを開発するというていで、使いそうなツールを用意した


---

- 自分の話とチュートリアルのどちらかを考えたけど、コミュニティの紹介もできるかなと思って（あとネタがたくさん作れるから）チュートリアルに切り替えた
...
---
  ...
  - 7時間やりきったけど、最初感覚が掴めなくて、とても早かったらしい。これはなかなかきがつかない

---

  - 自動文字起こしを用意していた。画面を見る方向けに喋りの不明瞭を解決できる？ > 現状だと厳しそう
